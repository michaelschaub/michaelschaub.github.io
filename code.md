...
Starting from 2021, codes associated to papers from my group can be found at the gitlab page     
[https://git.rwth-aachen.de/netsci](https://git.rwth-aachen.de/netsci).    
{: .notice--success}
